...
export function TestimonialsSection() {
  ...
  <section id="testimonials" className="py-20 px-4 relative overflow-hidden">
    ...
    <motion.div
      ...
      w-[800px] h-[800px] bg-gradient-to-br from-purple-500/10 to-pink-500/10 
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            >
              ...
              <Card
                className="p-6 border-2 border-slate-800 hover:border-purple-500/50 
                bg-gradient-to-br from-slate-900 to-slate-800 
                h-full flex flex-col relative overflow-hidden group"
              >

                {/* Quote Icon */}
                <Quote className="absolute top-4 right-4 w-12 h-12 
                text-purple-500/10 group-hover:text-purple-500/20 transition-colors" />
