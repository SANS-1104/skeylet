...
export function DashboardHeader({ currentPage, onPageChange }) {
  ...
  return (
    <header className="border-b border-white/20 bg-gradient-to-r from-white via-blue-50/50 to-indigo-50/50 backdrop-blur-lg shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        
        {/* LEFT: LOGO + PAGE NAME (mobile) */}
        <div className="flex items-center gap-4">
          ...
          <div className="md:hidden">
            <Badge
              ...
              className="bg-white/50 border-gray-200/50 backdrop-blur-sm"
            >
              {navItems.find(item => item.id === currentPage)?.label || "Create"}
            </Badge>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            onClick={() => onPageChange("create")}
            className="gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-700 hover:to-blue-800 shadow-lg transition-all duration-300 hover:scale-105"
            size="sm"
          >
            <Plus className="h-4 w-4" />
            <span className="hidden sm:inline">Create Post</span>
          ...
          {/* MOBILE MENU BUTTON */}
          <button
            className="md:hidden p-2 rounded-lg bg-white/50 border border-gray-200/50 shadow-sm hover:bg-white/80"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden px-4 pb-4 pt-2 bg-white/70 backdrop-blur-lg border-b border-gray-200 shadow-lg">
